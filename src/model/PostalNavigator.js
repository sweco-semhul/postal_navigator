...
class PostalNavigator {
  constructor(config) {
    ...
    initFFWDME() {
      ...
      var map = new ffwdme.components.MapboxGL({ el: $('#map'), styleURL: this.setupCustomLayer() || 'mapbox://styles/mapbox/streets-v8', center: { lat: 59.32954189015635, lng: 18.02458409970322 }, access_token: CREDENTIALS.mapboxToken });
