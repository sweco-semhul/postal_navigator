function init() {
  ...
  function setupCustomLayer() {
    ...
    var tilePath = "http://localhost:3004/pgm/tms/osm/sweden/sweden/{z}/{x}/{y}.pbf";
  ...
  var map = new ffwdme.components.MapboxGL({ el: $('#map'), styleURL: setupCustomLayer() || 'mapbox://styles/mapbox/streets-v8', center: { lat: 59.32954189015635, lng: 18.02458409970322 }, access_token: CREDENTIALS.mapboxToken });
